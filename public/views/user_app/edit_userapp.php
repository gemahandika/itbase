    ...
    <div class="app-content-header">
        ...
        <div class="container-fluid">
            ...
            <div class="row" style="border-bottom: 2px solid #000; padding-bottom: 5px;">
                <div class="col-sm-6">
                    <h5 class="mb-0">FORM EDIT USER APLIKASI</h5>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="card card-info card-outline mb-4">
                        <form class="needs-validation" novalidate method="post" action="../../../app/Controller/Userapp_controller.php">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control" id="validationCustom02" name="nama_user"
                                            value="<?= htmlspecialchars($data['nama_user']) ?>" required />
                                    </div>
                            ...
                            <div class="card-footer">
                                <button class="btn btn-info" type="submit" name="edit_userapp">Submit</button>
                            </div>
                        </form>
                        <script>
                            (() => {
