            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="d-flex">
                        ...
                        <a href="agen_tutup.php" type="button" class="btn btn-primary mb-4 mr-2">Download</a>
                        <a href="import.php" class="btn btn-success  mb-4">Upload</a>
                    </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td class="small text-center text-danger"><b><?= $data['pc_name'] ?></b></td>
                                    <td class="small text-center text-danger"><b><?= $data['fleet'] ?></b></td>
