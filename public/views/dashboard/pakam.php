...
session_start();
include '../../header.php';
include '../../../app/Models/Dashboard_models/Pakam_models.php';
...
<main class="app-main">
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0">Data Lubuk Pakam</h3>
                </div>
                <div class="col-sm-6">
                            ...
                            <div class="table-responsive">
                                <table id="example" class="display" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 0;
                                        $sql = mysqli_query($koneksi, "SELECT * FROM tb_counter WHERE status != 'TUTUP' AND cabang_counter = 'CABANG LUBUK PAKAM' ORDER BY id_counter DESC") or die(mysqli_error($koneksi));
                                        $result = array();
