                            ...
                            <div class="table-responsive">
                                <table id="example" class="display" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 0;
                                        $sql = mysqli_query($koneksi, "SELECT * FROM tb_counter WHERE status != 'TUTUP' AND cabang_counter = 'CABANG BINJAI' ORDER BY id_counter DESC") or die(mysqli_error($koneksi));
                                        $result = array();
