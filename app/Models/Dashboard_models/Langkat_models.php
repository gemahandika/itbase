...
$sql1 = "SELECT COUNT(*) AS total_jumlah FROM tb_counter WHERE status = 'AGEN' AND cabang_counter = 'CABANG LANGKAT'";
...
$sql2 = "SELECT COUNT(*) AS total_jumlah FROM tb_counter WHERE status = 'KP' AND cabang_counter = 'CABANG LANGKAT'";
...
$sql3 = "SELECT COUNT(*) AS total_jumlah FROM tb_counter WHERE status = 'AGEN' AND cabang_counter = 'CABANG LANGKAT' AND sistem != 'OFFLINE'";
...
$sql4 = "SELECT COUNT(*) AS total_jumlah FROM tb_counter WHERE status = 'AGEN' AND cabang_counter = 'CABANG LANGKAT' AND sistem = 'OFFLINE'";
...
$sql5 = "SELECT COUNT(*) AS total_jumlah FROM tb_counter WHERE status = 'AGEN' AND cabang_counter = 'CABANG LANGKAT' AND sistem = 'HYBRID'";
...
// Menghitung total jumlah KHUSU HYBRID
$sql6 = "SELECT COUNT(*) AS total_jumlah FROM tb_counter WHERE status = 'AGEN' AND cabang_counter = 'CABANG LANGKAT' AND sistem = 'MEC'";
