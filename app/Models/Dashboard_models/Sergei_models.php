...
$sql1 = "SELECT COUNT(*) AS total_jumlah FROM tb_counter WHERE status = 'AGEN' AND cabang_counter = 'CABANG SERDANG BEGADAI'";
...
$sql2 = "SELECT COUNT(*) AS total_jumlah FROM tb_counter WHERE status = 'KP' AND cabang_counter = 'CABANG SERDANG BEGADAI'";
...
$sql3 = "SELECT COUNT(*) AS total_jumlah FROM tb_counter WHERE status = 'AGEN' AND cabang_counter = 'CABANG SERDANG BEGADAI' AND sistem != 'OFFLINE'";
...
$sql4 = "SELECT COUNT(*) AS total_jumlah FROM tb_counter WHERE status = 'AGEN' AND cabang_counter = 'CABANG SERDANG BEGADAI' AND sistem = 'OFFLINE'";
...
$sql5 = "SELECT COUNT(*) AS total_jumlah FROM tb_counter WHERE status = 'AGEN' AND cabang_counter = 'CABANG SERDANG BEGADAI' AND sistem = 'HYBRID'";
...
// Menghitung total jumlah KHUSU HYBRID
$sql6 = "SELECT COUNT(*) AS total_jumlah FROM tb_counter WHERE status = 'AGEN' AND cabang_counter = 'CABANG SERDANG BEGADAI' AND sistem = 'MEC'";
